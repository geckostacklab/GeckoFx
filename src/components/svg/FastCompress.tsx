...
const THUNDER_PATHS = [
  ...
  "M535.05 202.814C533.423 204.172 530.16 205.807 526.884 206.899C523.182 208.133 518.71 208.8 515.435 210.17C513.848 210.834 512.159 211.532 510.933 213.159C510.516 214.247 510.516 215.866 510.381 217.105C510.246 218.344 509.976 219.154 509.698 221.624",
  "M535.868 192.182C534.241 194.358 530.978 196.533 527.702 199.395C522.224 204.183 510.524 201.718 509.027 202.941C506.705 206.077 505.339 208.531 504.525 209.487C503.981 209.635 503.172 209.095 502.337 207.721",
  "M535.869 162.74C533.971 162.471 530.16 160.843 527.02 158.39C525.239 156.999 525.237 154.3 524.832 152.53C524.112 149.379 519.52 150.203 518.158 149.389C514.534 147.223 516.249 141.207 515.157 140.393C514.072 139.584 515.423 137.126 515.018 135.355C512.16 133.847 508.357 132.759 505.073 130.718C504.521 130.035 504.251 129.226 503.973 128.392",
  "M535.868 152.926C533.709 151.847 532.057 150.481 531.24 148.715C530.961 146.678 530.692 144.756 530.013 143.125C529.604 142.303 529.064 141.493 526.872 139.023",
  "M584.12 162.74C586.827 160.033 590.933 155.388 591.072 153.757C591.222 151.999 589.035 150.481 588.213 149.12C587.622 148.139 590.925 147.75 592.155 147.476C592.303 147.443 591.497 147.741 592.025 148.015C594.223 149.157 598.547 148.837 601.548 148.433C604.488 148.036 600.199 141.771 601.425 138.218C602.374 136.586 603.74 135.212 605.237 133.99C605.924 133.307 606.463 132.497 607.837 131.663",
  "M583.302 170.919C584.93 170.649 588.733 169.561 592.421 167.79C593.361 167.339 594.458 167.108 595.149 166.564C597.888 164.408 599.643 160.843 602.648 159.203C605.647 157.567 605.654 153.752 606.602 152.526C610.283 152.379 613.546 151.847 616.821 149.663C617.643 149.115 618.453 148.576 620.105 148.019",
  "M584.12 206.085C587.097 206.085 593.1 207.165 596.24 208.94C600.029 211.081 600.199 215.883 601.556 222.147C601.885 223.662 604.795 223.26 605.907 223.799C607.019 225.419 607.289 227.611 607.563 229.651C607.567 230.612 607.297 231.422 607.837 233.891",
] as const
...
const THUNDER_GRADIENTS = [
  ...
  { x1: 522.374, y1: 202.814, x2: 522.374, y2: 221.624, stops: [0, 1] },
  { x1: 519.103, y1: 192.182, x2: 519.103, y2: 209.511, stops: [0, 1] },
  { x1: 519.921, y1: 128.392, x2: 519.921, y2: 162.74, stops: [1, 0] },
  { x1: 531.37, y1: 139.023, x2: 531.37, y2: 152.926, stops: [1, 0] },
  { x1: 595.979, y1: 131.663, x2: 595.979, y2: 162.74, stops: [1, 0] },
  { x1: 601.703, y1: 148.019, x2: 601.703, y2: 170.919, stops: [1, 0] },
  { x1: 595.979, y1: 206.085, x2: 595.979, y2: 233.891, stops: [1, 0] },
] as const
